...
export const ImageGenerationComposer = (props: ImageGenerationComposerProps) => {
  ...
  return (
    <form aria-label="图片生成输入" className="space-y-3 border-t border-gray-200 bg-white p-3" onSubmit={submit}>
      ...
      {props.prompt.endsWith('@') && props.references && props.references.length > 0 && (
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <input ref={uploadRef} aria-label="上传本地参考图" type="file" accept="image/png,image/jpeg,image/webp" className="sr-only" onChange={upload} />
        <button
          type="submit"
          aria-label="生成图片"
