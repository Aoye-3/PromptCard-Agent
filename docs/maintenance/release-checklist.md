...
- Confirm PromptCard Storage health reports schema v9, including `agentConversations`, conversation model bindings, and `skillHub`, before enabling the current application surface
