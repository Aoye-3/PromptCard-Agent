...
export const RecentCapturePreview = ({ capture }: { capture: RecentCaptureItemViewModel | null }) => {
  const { t } = useI18n()
  ...
  return (
    <div className="relative flex aspect-[16/10] items-center justify-center overflow-hidden rounded-lg border border-gray-200 bg-gray-950 text-white">
      {capture.thumbnailUrl ? (
        <img src={capture.thumbnailUrl} alt="" className="h-full w-full object-cover" />
      ) : (
