...
- B7: dedicated multi-view E2E remains `2/2 passed` in 47.2s. Human approval pending.
...
- F6 dedicated local Fake Provider suite: 2/2 passed in 47.2s, covering success, partial, failed-member-only retry, geometry, reload/project-switch deduplication, and lineage. PASS (existing automated evidence).
