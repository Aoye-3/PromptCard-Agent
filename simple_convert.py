...
def main():
    docx_path = r'f:\.workSpace\IICL-CardInterface\PromptCard-Manager\104种教学版+提示�?docx'
    output_dir = r'f:\.workSpace\IICL-CardInterface\PromptCard-Manager\104种教学提示词'
    ...
    print(f'已按分类拆分�?{len(categories)} 个文�?)
